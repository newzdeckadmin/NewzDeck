...
): check(marker in app,'v3.6.73 transport-attribution marker missing: '+marker)
...
): check(marker in app,'v3.6.73 Video policy marker missing: '+marker)
...
check('"schema_version": 10' in server and '"contract": "passive-runtime-browsing-performance"' in server,'Browsing telemetry schema 9/contract changed')
