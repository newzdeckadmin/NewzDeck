...
with tempfile.TemporaryDirectory(prefix="newzdeck-v3643-integrity-") as td:
    ...
    engine = module.MediaAutomationEngine(data_dir, lambda value:value, lambda value:value, _DummyDownloadManager(), lambda:[], version="3.6.90")
...
with tempfile.TemporaryDirectory(prefix="newzdeck-v3645-scan-") as td:
    engine=module.MediaAutomationEngine(pathlib.Path(td),lambda value:value,lambda value:value,_DummyDownloadManager(),lambda:[],version="3.6.90")
