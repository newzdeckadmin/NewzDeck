...
): check(marker in builder,'v3.6.86 builder protection missing: '+marker)
for marker in (
...
): check(marker in workflow,'v3.6.86 canonical workflow protection missing: '+marker)
...
print('v3.6.86 Defender LF build-pipeline regression guard: PASS')
