...
): check(marker in builder,'v3.7.0 builder protection missing: '+marker)
for marker in (
...
): check(marker in workflow,'v3.7.0 canonical workflow protection missing: '+marker)
...
print('v3.7.0 Defender LF build-pipeline regression guard: PASS')
