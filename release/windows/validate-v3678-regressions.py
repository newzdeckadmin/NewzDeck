...
): check(marker in builder,'v3.6.88 builder protection missing: '+marker)
for marker in (
...
): check(marker in workflow,'v3.6.88 canonical workflow protection missing: '+marker)
...
print('v3.6.88 Defender LF build-pipeline regression guard: PASS')
