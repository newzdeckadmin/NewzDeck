...
def make_auto(root: Path):
    engine = auto.MediaAutomationEngine(root, lambda value: value, lambda value: value, DummyDownloadManager(), lambda: [], version='3.6.62')
...
check('cache_write_requests=' in server_text and 'library_index_builds=' in server_text, 'Diagnostics report does not expose v3.6.62 local-data-path telemetry.')
...
check('<div class="version"><b>NewzDeck</b><span>v3.6.62</span></div>' in index_html, 'Visible sidebar footer version is not v3.6.62.')
