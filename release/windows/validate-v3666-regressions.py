...
for code in permanent_codes:
    check(f"'error_code': '{code}'" in server,f'Missing v3.6.70 failure class: {code}')
...
check('"schema_version": 8' in server and '"contract": "passive-runtime-browsing-performance"' in server,'Browsing telemetry schema 6/contract missing.')
