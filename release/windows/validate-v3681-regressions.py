...
engine=auto.MediaAutomationEngine(Path(tempfile.mkdtemp(prefix='newzdeck-v3681-guard-')),lambda x:x,lambda x:x,DummyDownloadManager(),lambda:[],version='3.6.84')
...
check(manifest.get('release')=='Wanted Upgrade Reasoning & Cutoff Policy Fix','Release manifest name mismatch')
print('v3.6.84 Automation Intelligence & Quality Profiles regression guard: PASS')
