...
engine=auto.MediaAutomationEngine(Path(tempfile.mkdtemp(prefix='newzdeck-v3681-guard-')),lambda x:x,lambda x:x,DummyDownloadManager(),lambda:[],version='3.6.85')
...
check(manifest.get('release')=='Wanted & Interactive Search Trait Coherency Fix','Release manifest name mismatch')
print('v3.6.85 Automation Intelligence & Quality Profiles regression guard: PASS')
