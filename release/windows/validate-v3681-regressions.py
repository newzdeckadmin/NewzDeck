...
engine=auto.MediaAutomationEngine(Path(tempfile.mkdtemp(prefix='newzdeck-v3681-guard-')),lambda x:x,lambda x:x,DummyDownloadManager(),lambda:[],version='3.7.0')
...
check(manifest.get('release')=='Production Milestone & Repository Hygiene','Release manifest name mismatch')
print('v3.7.0 Automation Intelligence & Quality Profiles regression guard: PASS')
