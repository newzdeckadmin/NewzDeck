...
engine=auto.MediaAutomationEngine(Path(tempfile.mkdtemp(prefix='newzdeck-v3681-guard-')),lambda x:x,lambda x:x,DummyDownloadManager(),lambda:[],version='3.6.86')
...
check(manifest.get('release')=='Automation Cache Snapshot Performance Hotfix','Release manifest name mismatch')
print('v3.6.86 Automation Intelligence & Quality Profiles regression guard: PASS')
