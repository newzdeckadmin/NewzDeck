...
engine=auto.MediaAutomationEngine(Path(tempfile.mkdtemp(prefix='newzdeck-v3681-guard-')),lambda x:x,lambda x:x,DummyDownloadManager(),lambda:[],version='3.6.83')
...
check(manifest.get('release')=='Quality Profile UI & Update Version Coherency','Release manifest name mismatch')
print('v3.6.83 Automation Intelligence & Quality Profiles regression guard: PASS')
