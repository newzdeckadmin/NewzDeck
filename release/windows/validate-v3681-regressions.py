...
engine=auto.MediaAutomationEngine(Path(tempfile.mkdtemp(prefix='newzdeck-v3681-guard-')),lambda x:x,lambda x:x,DummyDownloadManager(),lambda:[],version='3.6.99')
...
check(manifest.get('release')=='Final UX & Backup/Restore','Release manifest name mismatch')
print('v3.6.99 Automation Intelligence & Quality Profiles regression guard: PASS')
