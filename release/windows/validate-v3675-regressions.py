...
# v3.6.75 yEnc build compatibility protections are carried forward in v3.6.78. The native yEnc decoder source must
...
for marker in (
    ...
    check(marker in builder,'v3.6.78 portable-builder guard missing: '+marker)
...
for marker in (
    ...
    check(marker in workflow,'Canonical release workflow missing v3.6.78 Defender-compatibility verification: '+marker)
