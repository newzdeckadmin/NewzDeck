...
# Evidence-driven v3.6.74 policy: preserve client code, suppress only definitive codec/decoder limits.
for marker in (
...
): check(marker in (server+app),'v3.6.74 Video decode suppression marker missing: '+marker)
