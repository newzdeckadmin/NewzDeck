...
# Evidence-driven v3.6.85 policy: preserve client code, suppress only definitive codec/decoder limits.
for marker in (
...
): check(marker in (server+app),'v3.6.85 Video decode suppression marker missing: '+marker)
