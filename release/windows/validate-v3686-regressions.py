...
health_engine=auto.MediaAutomationEngine(Path(tempfile.mkdtemp(prefix='newzdeck-v3686-health-')),lambda x:x,lambda x:x,DummyDownloadManager(),lambda:[],version='3.6.93')
...
print('v3.6.86 Automation Cache Snapshot Performance Hotfix carried-forward guard under v3.6.93: PASS')
