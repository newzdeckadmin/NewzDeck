...
check('v=3.6.90-windows-defender-picker-release-gate-hardening' in index,'v3.6.87 asset cache identity missing')
...
health_engine=auto.MediaAutomationEngine(Path(tempfile.mkdtemp(prefix='newzdeck-v3686-health-')),lambda x:x,lambda x:x,DummyDownloadManager(),lambda:[],version='3.6.90')
...
print('v3.6.86 Automation Cache Snapshot Performance Hotfix carried-forward guard under v3.6.90: PASS')
