...
check('v=3.6.94-themes-color-schemes' in index,'v3.6.87 asset cache identity missing')
...
engine=auto.MediaAutomationEngine(root,lambda x:x,lambda x:x,DummyDownloadManager(),lambda:[],version='3.6.94')
...
health_engine=auto.MediaAutomationEngine(Path(tempfile.mkdtemp(prefix='newzdeck-v3686-health-')),lambda x:x,lambda x:x,DummyDownloadManager(),lambda:[],version='3.6.94')
...
print('v3.6.86 Automation Cache Snapshot Performance Hotfix carried-forward guard under v3.6.94: PASS')
