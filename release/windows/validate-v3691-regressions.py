...
check(hashlib.sha256(picker.encode()).hexdigest()=='df8b23aea5b8dfc18f43276759f3ef7d69dbd767e35eb191c133f6d8ffd97f46','reviewed v3.6.95 Picker source changed')
...
print('v3.6.91 release-gate compatibility intent carried forward under v3.6.95: PASS')
