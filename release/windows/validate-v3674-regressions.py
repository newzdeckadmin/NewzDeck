...
# v3.6.87 is diagnostics-only: request/session correlation and cancellation drain evidence.
for marker in (
...
): check(marker in app,'v3.6.87 client cancellation telemetry marker missing: '+marker)
for marker in (
...
): check(marker in server,'v3.6.87 server cancellation telemetry marker missing: '+marker)
