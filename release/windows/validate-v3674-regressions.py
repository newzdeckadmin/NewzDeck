...
# v3.6.81 is diagnostics-only: request/session correlation and cancellation drain evidence.
for marker in (
...
): check(marker in app,'v3.6.81 client cancellation telemetry marker missing: '+marker)
for marker in (
...
): check(marker in server,'v3.6.81 server cancellation telemetry marker missing: '+marker)
