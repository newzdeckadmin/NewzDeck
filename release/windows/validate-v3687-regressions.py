...
check(manifest.get('version')=='3.6.94' and manifest.get('base_version')=='3.6.93','build manifest lineage mismatch')
check('v=3.6.94-themes-color-schemes' in index,'v3.6.89 asset cache identity missing')
...
print('v3.6.87 Dynamic Range Evidence Authority user-visible behavior carried forward under v3.6.94: PASS')
