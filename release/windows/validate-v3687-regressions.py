...
check(manifest.get('version')=='3.6.88' and manifest.get('base_version')=='3.6.87','build manifest lineage mismatch')
...
# Preserve the v3.6.87 user-visible requirement even though v3.6.88 refines the
...
print('v3.6.87 Dynamic Range Evidence Authority user-visible behavior carried forward under v3.6.88: PASS')
