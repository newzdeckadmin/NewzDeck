...
check(manifest.get('version')=='3.7.0' and manifest.get('base_version')=='3.6.99','build manifest lineage mismatch')
...
print('v3.6.87 Dynamic Range Evidence Authority user-visible behavior carried forward under v3.7.0: PASS')
