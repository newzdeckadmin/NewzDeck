...
check(manifest.get('version')=='3.6.95' and manifest.get('base_version')=='3.6.94','build manifest lineage mismatch')
check('v=3.6.95-light-theme-readability-hotfix' in index,'v3.6.89 asset cache identity missing')
...
print('v3.6.87 Dynamic Range Evidence Authority user-visible behavior carried forward under v3.6.95: PASS')
