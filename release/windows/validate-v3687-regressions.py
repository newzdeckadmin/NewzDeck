...
check(manifest.get('version')=='3.6.90' and manifest.get('base_version')=='3.6.89','build manifest lineage mismatch')
...
print('v3.6.87 Dynamic Range Evidence Authority user-visible behavior carried forward under v3.6.90: PASS')
