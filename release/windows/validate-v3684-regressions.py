...
check('v=3.7.0-production-milestone-repository-hygiene' in index,'carried current asset cache identity missing')
...
print('v3.6.84 Wanted Upgrade Reasoning & Cutoff Policy Fix carried-forward guard under v3.7.0: PASS')
