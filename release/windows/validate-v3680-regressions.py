...
# reviewed v3.7.0 Quality Profile Builder suffix.
...
check(styles.count(next_marker)==1,'v3.7.0 stylesheet suffix marker count mismatch')
...
check("const UI_VERSION = '3.7.0'" in app and '3.7.0-production-milestone-repository-hygiene' in index,'UI/cache identity mismatch')
check(manifest.get('version')=='3.7.0' and manifest.get('base_version')=='3.6.99' and manifest.get('adapter_version')=='3.7.0','build manifest identity mismatch')
check(sab.ADAPTER_VERSION=='3.7.0' and sab.SAB_VERSION=='5.1.2','SAB identity changed')
