...
): check(marker in (server+app),'v3.6.72 Video post diagnostics marker missing: '+marker)
check('"schema_version": 9' in server and '"contract": "passive-runtime-browsing-performance"' in server,'Browsing telemetry schema 8/contract missing')
