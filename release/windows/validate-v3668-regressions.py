...
): check(marker in app,'v3.6.73 resolver accumulator marker missing: '+marker)
...
check('"schema_version": 10' in server and '"contract": "passive-runtime-browsing-performance"' in server,'Browsing telemetry schema 7/contract missing')
