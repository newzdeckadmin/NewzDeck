...
): check(marker in app,'v3.6.71 resolver accumulator marker missing: '+marker)
...
check('"schema_version": 9' in server and '"contract": "passive-runtime-browsing-performance"' in server,'Browsing telemetry schema 7/contract missing')
