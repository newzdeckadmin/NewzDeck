...
): check(marker in app,'v3.6.92 stable thumbnail identity marker missing: '+marker)
...
): check(marker in app,'v3.6.92 queue visibility telemetry marker missing: '+marker)
