...
): check(marker in app,'v3.6.95 stable thumbnail identity marker missing: '+marker)
...
): check(marker in app,'v3.6.95 queue visibility telemetry marker missing: '+marker)
