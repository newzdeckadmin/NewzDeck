...
): check(marker in app,'v3.6.84 stable thumbnail identity marker missing: '+marker)
...
): check(marker in app,'v3.6.84 queue visibility telemetry marker missing: '+marker)
