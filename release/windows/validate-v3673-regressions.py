...
): check(marker in app,'v3.6.89 stable thumbnail identity marker missing: '+marker)
...
): check(marker in app,'v3.6.89 queue visibility telemetry marker missing: '+marker)
