...
): check(marker in app,'v3.6.80 stable thumbnail identity marker missing: '+marker)
...
): check(marker in app,'v3.6.80 queue visibility telemetry marker missing: '+marker)
