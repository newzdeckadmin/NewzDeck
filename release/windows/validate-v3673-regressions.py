...
): check(marker in app,'v3.6.96 stable thumbnail identity marker missing: '+marker)
...
): check(marker in app,'v3.6.96 queue visibility telemetry marker missing: '+marker)
