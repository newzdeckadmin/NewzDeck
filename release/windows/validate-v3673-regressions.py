...
): check(marker in app,'v3.6.77 stable thumbnail identity marker missing: '+marker)
...
): check(marker in app,'v3.6.77 queue visibility telemetry marker missing: '+marker)
