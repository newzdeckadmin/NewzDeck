...
): check(marker in app,'v3.6.81 stable thumbnail identity marker missing: '+marker)
...
): check(marker in app,'v3.6.81 queue visibility telemetry marker missing: '+marker)
