...
): check(marker in app,'v3.6.85 stable thumbnail identity marker missing: '+marker)
...
): check(marker in app,'v3.6.85 queue visibility telemetry marker missing: '+marker)
