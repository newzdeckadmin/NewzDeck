...
): check(marker in app,'v3.6.76 stable thumbnail identity marker missing: '+marker)
...
): check(marker in app,'v3.6.76 queue visibility telemetry marker missing: '+marker)
