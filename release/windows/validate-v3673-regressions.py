...
): check(marker in app,'v3.6.90 stable thumbnail identity marker missing: '+marker)
...
): check(marker in app,'v3.6.90 queue visibility telemetry marker missing: '+marker)
