...
): check(marker in app,'v3.6.94 stable thumbnail identity marker missing: '+marker)
...
): check(marker in app,'v3.6.94 queue visibility telemetry marker missing: '+marker)
