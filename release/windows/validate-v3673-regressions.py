...
): check(marker in app,'v3.6.86 stable thumbnail identity marker missing: '+marker)
...
): check(marker in app,'v3.6.86 queue visibility telemetry marker missing: '+marker)
