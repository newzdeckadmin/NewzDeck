...
): check(marker in app,'v3.6.91 stable thumbnail identity marker missing: '+marker)
...
): check(marker in app,'v3.6.91 queue visibility telemetry marker missing: '+marker)
