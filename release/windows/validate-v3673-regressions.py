...
): check(marker in app,'v3.6.73 stable thumbnail identity marker missing: '+marker)
...
): check(marker in app,'v3.6.73 queue visibility telemetry marker missing: '+marker)
...
check('"schema_version": 10' in server and '"contract": "passive-runtime-browsing-performance"' in server,'Browsing telemetry schema 10/contract missing')
