...
): check(marker in app,'v3.6.82 stable thumbnail identity marker missing: '+marker)
...
): check(marker in app,'v3.6.82 queue visibility telemetry marker missing: '+marker)
