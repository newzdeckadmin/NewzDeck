...
): check(marker in app,'v3.6.99 stable thumbnail identity marker missing: '+marker)
...
): check(marker in app,'v3.6.99 queue visibility telemetry marker missing: '+marker)
