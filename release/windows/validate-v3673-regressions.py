...
): check(marker in app,'v3.6.83 stable thumbnail identity marker missing: '+marker)
...
): check(marker in app,'v3.6.83 queue visibility telemetry marker missing: '+marker)
