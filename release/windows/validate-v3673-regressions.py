...
): check(marker in app,'v3.6.88 stable thumbnail identity marker missing: '+marker)
...
): check(marker in app,'v3.6.88 queue visibility telemetry marker missing: '+marker)
