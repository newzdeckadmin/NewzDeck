...
): check(marker in app,'v3.6.87 stable thumbnail identity marker missing: '+marker)
...
): check(marker in app,'v3.6.87 queue visibility telemetry marker missing: '+marker)
