...
): check(marker in app,'v3.6.79 stable thumbnail identity marker missing: '+marker)
...
): check(marker in app,'v3.6.79 queue visibility telemetry marker missing: '+marker)
