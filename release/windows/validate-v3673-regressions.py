...
): check(marker in app,'v3.6.93 stable thumbnail identity marker missing: '+marker)
...
): check(marker in app,'v3.6.93 queue visibility telemetry marker missing: '+marker)
