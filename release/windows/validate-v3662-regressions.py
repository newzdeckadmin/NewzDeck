...
check(len(body) == 1, 'Could not locate the v3.6.74 overview merge helper.')
...
check('updateNameResolutionActivityDomInPlace' in app_js, 'v3.6.74 removed the targeted name-resolution activity updater.')
...
check("version='3.6.74'" in auto_text, 'Automation default version identity did not migrate to v3.6.74.')
