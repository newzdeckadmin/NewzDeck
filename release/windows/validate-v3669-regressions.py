...
): check(marker in server,'v3.6.71 settings reliability marker missing: '+marker)
...
check('"schema_version": 9' in server and '"contract": "passive-runtime-browsing-performance"' in server,'Browsing telemetry schema 7/contract changed')
