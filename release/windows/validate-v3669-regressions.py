...
): check(marker in server,'v3.6.73 settings reliability marker missing: '+marker)
...
check('"schema_version": 10' in server and '"contract": "passive-runtime-browsing-performance"' in server,'Browsing telemetry schema 7/contract changed')
