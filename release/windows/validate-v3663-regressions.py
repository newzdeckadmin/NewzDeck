...
check("version='3.7.0'" in auto_text, 'Automation default version identity did not migrate.')
...
check('3.7.0-production-milestone-repository-hygiene' in index_html, 'Static cache identity is missing.')
check('<div class="version"><b>NewzDeck</b><span>v3.7.0</span></div>' in index_html, 'Visible UI version is not v3.7.0.')
