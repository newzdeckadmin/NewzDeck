...
check("version='3.6.74'" in auto_text, 'Automation default version identity did not migrate.')
...
check('"schema_version": 11' in server_text and '"contract": "passive-runtime-browsing-performance"' in server_text, 'Browsing telemetry schema/contract is not v3.6.74.')
check('3.6.74-video-cancellation-overlap-diagnostics' in index_html, 'Static cache identity is missing.')
check('<div class="version"><b>NewzDeck</b><span>v3.6.74</span></div>' in index_html, 'Visible UI version is not v3.6.74.')
