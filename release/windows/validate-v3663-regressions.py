...
check("version='3.6.95'" in auto_text, 'Automation default version identity did not migrate.')
...
check('3.6.95-light-theme-readability-hotfix' in index_html, 'Static cache identity is missing.')
check('<div class="version"><b>NewzDeck</b><span>v3.6.95</span></div>' in index_html, 'Visible UI version is not v3.6.95.')
