...
check("version='3.6.72'" in auto_text, 'Automation default version identity did not migrate.')
...
check('"schema_version": 9' in server_text and '"contract": "passive-runtime-browsing-performance"' in server_text, 'Browsing telemetry schema/contract is not v3.6.72.')
check('3.6.72-browse-timeout-error-attribution' in index_html, 'Static cache identity is missing.')
check('<div class="version"><b>NewzDeck</b><span>v3.6.72</span></div>' in index_html, 'Visible UI version is not v3.6.72.')
