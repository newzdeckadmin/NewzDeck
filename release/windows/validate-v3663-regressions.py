...
check("version='3.6.90'" in auto_text, 'Automation default version identity did not migrate.')
...
check('3.6.90-windows-defender-picker-release-gate-hardening' in index_html, 'Static cache identity is missing.')
check('<div class="version"><b>NewzDeck</b><span>v3.6.90</span></div>' in index_html, 'Visible UI version is not v3.6.90.')
